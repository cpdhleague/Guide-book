...
Such a simple question, it seems trivial to not have an immediate answer, right? I mean, after all, the purpose of playing the game is to win the game… shouldn’t that be the focus of the deck? 
...
Let's find out what our Champions of the format have done to achieve their success. As far as Champions go, at the time of this article, there’s a deck we simply can’t ignore. We see it in her number of **Top 4 Wins**, we know her by name.

Let’s begin with the most decorated deck in the format; our crowned cPDH GOAT: **Gretchen Titchwillow**.

<img src="/Guide-book/assets/images/gretchen.jpg" alt="Description" style="width: 50%; display: block; margin: 0 auto;">
...
> “This is an entirely fair beatdown deck… (and) when nobody has any cards, (with) their creatures have been eroded by edicts and sweepers, (winning the game) is pretty trivial.”
> — <cite>PapaPauper, Sanctuary Series VII Champion Interview (14:02)</cite>
...
**BeachBodGod69** is an avid cPDH meta enjoyer and a true believer in the power of Mystic Enforcer. If you want to discuss his thoughts in more detail, be sure to ping him in server on the [**cPDH.guide Discord**](https://discord.com/invite/UtgN272kpq).

*Be sure to watch this article's [companion video](https://youtu.be/zsYjhPNB1J8) where we discuss peripheral concepts related to the article.*
