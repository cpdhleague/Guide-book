...
# SECTION 3: IMAGES
# ===========================================================================
# TODO: Replace the placeholder image paths with a real tournament image
# once one is available. Upload to assets/images/ first.

image: /assets/images/gin-typehype.jpg
...
excerpt: "Ginger Persolus takes home the first trophy of the 2026 season at Wanderer's Type Hype."  # Required for GNews — fill this in before publishing to Google News
...
{% include card-grid.html cards="Myr Retriever, Workshop Assistant, Ashnod's Altar, Etherium Sculptor, Secret Door" %}
