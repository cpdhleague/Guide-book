...
# TODO: Replace with a real image before publishing
image: /assets/images/zetaset.jpg

header:
  overlay_image: /assets/images/header2025-1.png
  overlay_filter: 0.5
  teaser: /assets/images/zetaset.jpg
...
The *Secret Lair* crossover between Magic and the Brooklyn art collective MSCHF has created some mischief of its own. The Zeta Set reprints 121 cards in the style of Magic's 1992 playtest cards — photocopied, hand-cut, and weird — and in doing so printed twelve cards at common for the first time and dropped a handful of creatures to uncommon.

Wizards and the Pauper Format Panel initially ruled the downshifts wouldn't affect Pauper legality. After a week of community feedback, they reversed course. [Gavin Verhey's full statement is worth reading](https://magic.wizards.com/en/news/announcements/on-the-zeta-set-in-pauper).
...
[[Obeka, Brute Chronologist]] is a favorite of mine in EDH, but the port to PDH doesn't bring the splashier effects from non-common cards in the 99 that Obeka usually relies on to get infinite turns or acrue obscene value. The fun part of Obeka is that ending the turn exiles the stack and every ability or spell that was on it. This allows Obeka to enjoy the benefits of some cards while also exiling the downsides that would usually come with those effects later. Enjoying only the extra value and removing the drawbacks sounds great, but common cards don't push these concepts as far as EDH, where you can find cards that will allow you to take extra turns with the drawback of losing the game at that extra turn's endstep. Another difficulty is that some mechanics have effects that want to be exiled during combat, during a main phase (land triggers), or during the end step. Sometimes you wont' be able to play all of your best cards on any given turn because you need to decide which drawbacks are too costly. 
...
**Token production with a sacrifice clause** works the same way. Mobilize gives you creatures that leave at the end step; [[Mordor Trebuchet]] does something similar if you're attacking with a Goblin or Orc.
...
One idea worth checking out might be self-milling until we can cast [[Dragon's Approach]] to tutor into [[Tiamat's Fanatics]], cheating our favorite card straight into play and beginning the token explosion across our board.

[[Freed from the Real]] lets you activate Obeka multiple times per turn cycle , allowing you to politic and discourage the whole table from committing to end-step plays, because you can exile those effects, spells, and activations. You will need to have the support of the player whose turn it is, but there are times where such collaboration will make perfect sense. 

{% include card-grid.html cards="Dragon's Approach; Tiamat's Fanatics; Ideas Unbound;" %}

I'll be building Obeka because she's fun and there are some terrific ways to abuse her abilities. I don't suspect we'll be seeing a lot of her at any tournaments, however. The fun interactions with her ablities are limited to midrange value generation. Not fast enough to out-aggro Gut, not strong enough to out-value Imoti.


### 3. The Jolly Balloon Man

{% include card-grid.html cards="The Jolly Balloon Man;" %}
...
[[Garth One-Eye]] has made his rounds in EDH and cEDH — the "make a [[Black Lotus]]" commander has appeal both to casual players who want to play with copies of the Power Nine card and combo players ready to make infinite mana. Competitive builds lean on blink and haste effects to reuse his ability, generating infinite mana off repeated Lotuses. [[Displacer Kitten]], [[Deadeye Navigator]], and haste enablers are the usual suspects in EDH.

Brewers in our Discord are already circling Garth, looking for ways to convert these combos into the format using only commons. The most efficient line at the moment appears to be [[First Day of Class]] as the haste enabler with [[Antler Skulkin]] to grave flicker Garth, making a Lotus before flickering him again. Each loop nets you one mana of any color, eventually giving you infite WUBRG. In addition to the sparkling Black Lotus, Garth offers a wealth of control pieces and value at instant speed, and as a five-color commander he has access to every common in the format. That last part is no small thing. Garth might not need to combo at all. Because he offers so much raw utility, we may see our first real five-color good-stuff deck — a list that functions entirely without its commander, with Garth in the command zone as a mixed bag of support pieces instead of being a driving engine.
...
{% include card-grid.html cards="An Offer You Can't Refuse;" %}

One-mana counterspells are rare and very good for PDH. We've seen this card's flexibility in cEDH, where it doubles as a pseudo-ritual — you can give yourself the two treasures in a pinch, or at instant speed before your next turn. 

Good cards are good. What more can we say?

### Dispatch and Cut Down

{% include card-grid.html cards="Dispatch; Cut Down;" %}

[[Dispatch]] is a welcome card and an excellent removal tool in white — a color that wants more cheap removal, especially at instant speed. Most decks can run an artifact land or two, plus their normal array of mana rocks to turn Dispatch into a [[Swords to Plowshares]].

[[Cut Down]] is another removal spell for black, very cheap but also a bit limited due to the power/toughness restrictions.

These are nice, cheap forms of removal, but nothing too startling or extraordinary. They'll see play. 

### Soul-Guide Lantern

{% include card-grid.html cards="Soul-Guide Lantern;" %}

Very similar to existing cards like [[Relic of Progenitus]], so while we'll definitely be seeing more of it, it's not going to change things all too significantly. In fact, it's generally a downgrade to Relic — so decks looking to run only one of this effect will probably be turning to older cards first. The upside to such a card is that you can run it in your deck that cares about graveyards. Relic usually removes your own graveyard too, while Lantern only hits your opponents. 

### Vandalblast

{% include card-grid.html cards="Vandalblast;" %}

[[Vandalblast]] would be the first artifact wipe in our format if it stays legal.

Graveyard decks like [[Hollow Marauder]] have lived with comparable hate for a while, though refilling a graveyard is generally easier than rebuilding a board of artifacts. An artifact wipe would be devastating to decks that have built their entire plans around artifacts. 
...
{% include card-grid.html cards="Price of Progress;" %}

[[Price of Progress]] is an interesting arrival. In certain decks, like an efficient [[Glaring Fleshraker]], you're incentivised to run a lot of nonbasics for the abilities the cards grant you. Same for 3- and 5-color decks looking to fix their mana with tapped or fetch lands. How does Price of Progress affect these decks? Colorless decks certainly won't be able to stop this card on the stack. Multicolored decks would be more likely to have blue in their mix, but it's still a scary threat to be staring down when you'd been holding up interaction for a [[Malcolm, Keen-Eyed Navigator]].

On the other hand, maybe there aren't enough nonbasics out there to affect things in the way I think there are. There are a lot of top decks in the meta right now running few nonbasic lands. The card is also symmetrical — it hits each player, the caster included — and even mono-red lists tend to run some nonbasics.

I don't think there's a great concern for the power level of the card, but I am curious how such a card would affect deckbuilding. Plenty of decks running nonbasics can't counter it and can't gain life fast enough to shrug it off. Being able to pick your lands freely is a big part of how three- and five-color decks come together. They don't need another reason to stay home. 
...
We're waiting to hear final word on which of these cards will be legal in PDH, but since the committee has long been oriented toward keeping the banlist as small as possible, I'm of the hope that we see all of these cards in action — at least for some time — before we have any bans.

For us, the practical takeaway is that there are new decks to build. Raffine is ready to go. Garth is a puzzle worth solving. There's new interaction to fit into existing lists, and a couple of cards that might change how you think about your manabase.

Whatever the rulings, we're excited to see new cards, new potential, and how these surprise adjustments shake up the meta.

Do you agree with our analysis? Are there major factors we've missed? Let us know in [our Discord](https://discord.com/invite/UtgN272kpq).
