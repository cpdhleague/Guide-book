...
<table style="max-width: 650px" style="max-width: 100%">
  ...
  <tr>
    <td>Commander Elo: 1,687</td>
    <td>Active Pilots: 7</td>
    <td>Top Player Elo: 1,384</td>
  </tr>
  <tr>
    <td>Win rate equivalent: 52%</td>
    <td>Games Played: 37</td>
    <td>Win rate equivalent: 39%</td>
  </tr>
  <tr>
    <td>Elo Change: +330</td>
    <td>Events Played: 7</td>
    <td>Top Player Rank: 6</td>
  </tr>
  </tbody>
</table>
