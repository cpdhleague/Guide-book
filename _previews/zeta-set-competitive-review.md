...
[[Freed from the Real]] lets you activate Obeka multiple times per turn cycle, allowing you to politic and discourage the whole table from committing to end-step plays, because you can exile those effects, spells, and activations.
...
Healthy shake-up or diversity problem? I don't know. That's the kind of thing you find out by playing it. Casual is its own conversation, and I suspect this won't be a welcome card in those circumstances.
...
My concern with it isn't power level. It's what it does to deckbuilding. Plenty of decks running nonbasics can't counter it and can't gain life fast enough to shrug it off. Being able to pick your lands freely is a big part of how three- and five-color decks come together. They don't need another reason to stay home. 

I want people brewing weird stuff. That's most of the appeal of PDH for me. A card that adds risk to an otherwise very measured and efficient mana base doesn't seem like ideal. 

It's a strong card, and it requires very little build-around from the pilots bringing it to the table. It'll be interesting to discover whether it makes a big impact on existing decks, or mostly makes decks that want a variety of lands harder to build — since they'd also need to weigh the chance of getting exploded for big damage out of nowhere.
